...
int generate_report(const char * output_path, memory_parameters_t memory_parameters, memory_t memory) {
    ...
    printf("----------------------\n");
    printf("Total de cache hits: %d.\n", memory.cache_write_count + memory.cache_read_count);
    printf("Total de cache miss: %d.\n", memory.memory_read_count + memory.memory_write_count);
    printf("----------------------\n");
